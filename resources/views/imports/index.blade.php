...
$(document).ready(function(){
    ...
    let data_table = $('#thisTable').DataTable({
        ...
        columns: [
            ...
            { data: "import_no", orderable:false, className: 'dt-body-center dt-head-center'},
            { data: "import_name", orderable:false, className: 'dt-body-center dt-head-center'},
            { data: "import_material_list", orderable:false, className: 'dt-body-center dt-head-center'},
            { data: "import_price", orderable:false, searchable:false, className: 'dt-body-center dt-head-center'},
            { data: "import_description", orderable:false, className: 'dt-body-center dt-head-center'},
        ],
        paging: false,
        // searching: false,
        info: false,
    ...
    $('#thisTable tbody').on('dblclick', 'tr', function () {
        ...
        window.location.href = "/imports/" + data["import_id"] + "/edit";
    } );
    ...
    $("#delete_btn").click(function(){
        ...
        data_table.rows().every(function(index, element) {
            ...
            if(checkbox.prop("checked")){
                checked_row_id.push(all_data[index]["import_id"]);
            }
        });
